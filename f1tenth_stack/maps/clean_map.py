...
def filter_with_expanded_black(input_file, output_file, dilation_radius=5):
    # Load the PGM file
...
input_path = '/home/capstone/f1host_ws/src/f1tenth_system/f1tenth_stack/maps/31march.pgm'  # Replace with the path to your input PGM file
output_path = '/home/capstone/f1host_ws/src/f1tenth_system/f1tenth_stack/maps/31march.pgm'  # Replace with the desired output PGM file path
